 ...
 *
 * Core Rules:
 * - Cafeteria Admin creates managers, waiters, chefs, tables, menu, sections
 * - Cafeteria Admin can allow/block manager login
 * - Cafeteria Admin or manager can allow/block waiter and chef login
...
export function canGrantLoginPermission(grantingUserRole: string, targetStaffRole: string): boolean {
  // Cafeteria Admin can grant to anyone
...
export function canAssignToSections(assigningUserRole: string): boolean {
  // Only Cafeteria Admin can assign sections
...
export function canAssignToCategories(assigningUserRole: string): boolean {
  // Only Cafeteria Admin can assign categories
  return assigningUserRole === "cafeteria_admin";
}
...
export function getVisibleSections(
  ...
  // Chefs and Cafeteria Admins see all sections
...
export function getVisibleCategories(
  ...
  // Waiters and Cafeteria Admins see all categories
