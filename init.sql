CREATE TYPE "public"."commission_status" AS ENUM('pending', 'available', 'withdrawn');;
CREATE TYPE "public"."ledger_type" AS ENUM('points_deduction', 'points_credit', 'commission_pending', 'commission_available', 'commission_withdrawn', 'recharge_approval', 'points_cancelled');;
CREATE TYPE "public"."login_method" AS ENUM('email', 'google', 'github');;
CREATE TYPE "public"."order_item_status" AS ENUM('pending', 'sent_to_kitchen', 'in_preparation', 'ready', 'served', 'cancelled');;
CREATE TYPE "public"."order_status" AS ENUM('open', 'closed', 'cancelled');;
CREATE TYPE "public"."period_type" AS ENUM('global_first_time', 'special_grant');;
...
CREATE TYPE "public"."bill_split_status" AS ENUM('pending', 'partially_paid', 'fully_paid', 'cancelled');;
CREATE TYPE "public"."kitchen_lock_status" AS ENUM('locked', 'unlocked');;
CREATE TYPE "public"."order_escalation_status" AS ENUM('active', 'resolved');;
ALTER TYPE "public"."order_item_status" ADD VALUE 'waiter_review' BEFORE 'pending';;
...
;
ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'cafeteria_admin';;
ALTER TABLE "cafeteriaStaff" ADD COLUMN "phone" varchar(20);;
ALTER TABLE "cafeteriaStaff" ADD COLUMN "referenceCode" varchar(50);;
ALTER TABLE "cafeterias" ADD COLUMN "subscriptionPlan" varchar(50) DEFAULT 'starter';;
ALTER TABLE "cafeterias" ADD COLUMN "subscriptionStatus" varchar(50) DEFAULT 'active';;
ALTER TABLE "commissionDistributions" ADD COLUMN "percentage" numeric(5, 2);;
ALTER TABLE "commissionDistributions" ADD COLUMN "releasedAt" timestamp;;
ALTER TABLE "ledgerEntries" ADD COLUMN "balanceBefore" numeric(15, 2);;
ALTER TABLE "ledgerEntries" ADD COLUMN "balanceAfter" numeric(15, 2);;
ALTER TABLE "rechargeRequests" ADD COLUMN "paidAmount" numeric(10, 2);;
ALTER TABLE "rechargeRequests" ADD COLUMN "paidCurrency" varchar(3);;
ALTER TABLE "rechargeRequests" ADD COLUMN "exchangeRateToUsd" numeric(10, 4);;
ALTER TABLE "rechargeRequests" ADD COLUMN "pointsMultiplier" numeric(10, 2);;
ALTER TABLE "cafeteriaStaff" ADD CONSTRAINT "cafeteriaStaff_referenceCode_unique" UNIQUE("referenceCode");;
ALTER TABLE "public"."cafeteriaStaff" ALTER COLUMN "role" SET DATA TYPE text;;
DROP TYPE "public"."staff_role";;
CREATE TYPE "public"."staff_role" AS ENUM('cafeteria_admin', 'manager', 'waiter', 'chef');;
ALTER TABLE "public"."cafeteriaStaff" ALTER COLUMN "role" SET DATA TYPE "public"."staff_role" USING "role"::"public"."staff_role";;
ALTER TABLE "public"."users" ALTER COLUMN "role" SET DATA TYPE text;;
DROP TYPE "public"."user_role";;
CREATE TYPE "public"."user_role" AS ENUM('owner', 'marketer', 'cafeteria_admin', 'manager', 'waiter', 'chef');;
...
;
ALTER TABLE "cafeterias" ADD COLUMN "phone" varchar(20);;
ALTER TABLE "cafeterias" ADD COLUMN "latitude" numeric(10, 8);;
ALTER TABLE "cafeterias" ADD COLUMN "longitude" numeric(11, 8);;
ALTER TABLE "cafeterias" ADD COLUMN "tax_rate" numeric(5, 4) DEFAULT '0.00';;
ALTER TABLE "cafeterias" ADD COLUMN "service_charge" numeric(5, 4) DEFAULT '0.00';;
ALTER TABLE "cafeterias" ADD COLUMN "auto_logout_minutes" integer DEFAULT 120;;
ALTER TABLE "rechargeRequests" ADD COLUMN "payment_method" varchar(50);;
